 ...
 * and waits for the user's response via an HTTP callback to MetroAI.
 *
 * This enables delete-confirmation modals on the MetroAI desktop app
...
const plugin = {
  ...
  description: 'Structured user confirmation tool for MetroAI desktop.',
  configSchema: {
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerTool((ctx) => {
      // Only enable for MetroAI desktop sessions (sessionKey starts with 'agent:main:lobsterai:').
